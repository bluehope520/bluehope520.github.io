...
function getTravelRecommendation(e) {
  ...
  myHeaders.append("Authorization", "Bearer app-N2iPquu9qGQMLoUBL7765k7F");
  myHeaders.append("Content-Type", "application/json");

  const raw = JSON.stringify({
    inputs: {
      location: stationName,
      station_Name: stationLocation,
    },
  ...
  // document.getElementById("travel-recommendation-info").innerText = result.data.outputs.text
